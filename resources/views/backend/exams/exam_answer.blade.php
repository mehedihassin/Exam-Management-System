...
<body>
    <section class="container" style="min-height: 100vh;">
        <div class="question_answer">
            ...
            <hr>
            <a href="{{ route('exam_question_paper_pdf') }}" class="btn btn-primary btn-sm mb-3 me-end"><i class="fa-solid fa-file-pdf"></i> Generate PDF</a>
          ...
          <a href="{{ route('dashboard') }}" class="btn btn-primary btn-sm text-white mt-4"><i class="fa-solid fa-house"></i> Go Dashboard</a>
        </section>
