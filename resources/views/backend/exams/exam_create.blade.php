            ...
            <form action="{{ route('exam_store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 form-group mb-3">
                        ...
                        <input type="number" name="total_question" class="form-control" id="totalQuestions"
                            placeholder="Enter Total Questions" required>
                    </div>
                    <div class="col-md-4 form-group">
                ...
                <button type="submit" class="btn btn-primary btn-sm"><i class="fa-solid fa-floppy-disk"></i> Save
                    Exam</button>
            </form>
        </div>
    @endsection
