    ...
    <section class="container">
        <div class="question_answer">
            ...
            @php
                $sl = 1;
            @endphp
            <div class="row mt-3 g-4" style="display: grid; grid-template-columns: repeat(2, 1fr);">
                       ...
                       <div class="col-md-6">
                        ...
                        <p><strong>Your Answer:</strong>
                                ...
                                @elseif($record->submitted_answer !== $record->question->correct_answer)
                                  ...
                                  <p><strong >Correct answer:</strong>  <span style="color: green">{{ $record->question->correct_answer }}</span></p>
